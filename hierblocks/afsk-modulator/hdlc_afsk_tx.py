...
# Title: Hdlc Afsk Tx
# Generated: Wed Sep 23 12:41:09 2020
##################################################
...
from afsk_mod import afsk_mod  # grc-generated hier_block
...
class hdlc_afsk_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.hdlc_frame_encoder_0 = hdlc_frame_encoder(
            tail_seq=3,
            training_seq=40,
            training_symb=train_symb[0 if random.uniform(0,1) < 0.5 else 1],
        )
        ...
        self.connect((self.afsk_mod_0, 0), (self.qtgui_freq_sink_x_1, 0))
        self.connect((self.afsk_mod_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.hdlc_frame_encoder_0, 0), (self.afsk_mod_0, 0))
    ...
    def set_train_symb(self, train_symb):
        ...
        self.hdlc_frame_encoder_0.set_training_symb(self.train_symb[0 if random.uniform(0,1) < 0.5 else 1])
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.afsk_mod_0.set_samp_rate(self.audio_rate)
